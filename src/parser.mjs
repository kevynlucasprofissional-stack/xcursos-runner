...
export function normalizeLiveLessonMeta(meta = {}, page = {}) {
  ...
  const materialOnly=isMaterialOnlyLesson(result);
  return {...result,hasUntrustedIframe:materialOnly?false:hasUntrustedIframe,mediaSourceConfidence:mediaSourceConfidence(result),materialOnly};
}